...
#%% import data
with open('listofbirdcounters.pickle', 'rb') as handle:
...
def save_scorelist(filename,scorelist,extension=".txt"):
...
def generate_output_lists(filename,birdscore,species_birdscore=None):
    ...
    #unique_top_birds = quick_top_birdscores(top_states)
    unique_top_birds = unique_top_birdscores(birdscore)
    #print(compare_to_REALSTATEBIRDS(unique_top_birds))
    #print(check_for_iconic_birds(unique_top_birds))
    #print(find_duplicate_topbirds(top_birds).most_common())
    ...
    save_scorelist(filename+'_markdownsource',markdown_unique_top_birds,extension=".md")
